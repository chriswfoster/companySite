...
<div>
<p>Last Name</p>
<input placeholder="Your last name." onChange={(e)=> this.lnText(e.target.value)}/></div><div>
<p>Your Email Address</p>
<input placeholder="Your email address." onChange={(e)=> this.emailText(e.target.value)} /></div><div>
<p>Company Name (optional)</p>
<input placeholder="Name of the company you represent." style={{width: "13vw"}} onChange={(e)=> this.cnText(e.target.value)}/></div><div>
<p>Phone Number</p>
<input placeholder="The best number to reach you at."  style={{width: "13vw"}} onChange={(e)=> this.pnText(e.target.value)}/></div><div>
<p> Service Location</p>
<textarea placeholder="City, state, address, or any general information about the location of service."  style={{width: "15vw", height: "5vh"}}onChange={(e)=> this.slText(e.target.value)}/></div><div>
<p>Special Hardware Requests</p>
<input placeholder="Hardware brand/model/type" onChange={(e)=> this.hwText(e.target.value)}  style={{width: "10vw"}}/></div><div>
<p>Additional Information</p>
<textarea placeholder="Additional information about your request" onChange={(e)=> this.aiText(e.target.value)} style={{width: "15vw", height: "10vh", marginRight: "5vh"}}/></div>
